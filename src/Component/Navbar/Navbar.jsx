    ...
    return (
        <nav className='flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20'>
            ...
            <ul className={`${menu ? "block" : "hidden"
                ...
                <a href="#About">
                    <li className='text-md transition-all duration-300 p-1 md:p-0 link'>About</li>
                </a>
                <a href="#Experience">
                    <li className='text-md transition-all duration-300 p-1 md:p-0 link'>Experience</li>
                </a>
                <a href="#Projects">
                    <li className='text-md transition-all duration-300 p-1 md:p-0 link'>Projects</li>
                </a>
                <a href="#Footer">
                    <li className='text-md transition-all duration-300 p-1 md:p-0 link'>Contact</li>
                </a>
            </ul>
            {showMenu ? (
